-- Purpose : top sql_id(s) responsible of  PGA or TEMP space consumption during a particular period of time
-- Source : https://bdrouvot.wordpress.com/2013/03/19/link-huge-pga-temp/

-- High PGA consumption ------------------------------------------
prompt
prompt ********************
prompt High PGA consumption
prompt ********************
...
prompt
prompt ***************************
prompt High TEMP space consumption
prompt ***************************
col percent head '%' for 99990.99
col star for A10 head ''
